...
namespace BonusPointManager.Migrations
{
    ...
    [Migration("20220611185749_AddRunwayHeadingDetails")]
    partial class AddRunwayHeadingDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BonusPointManager.Models.Flights.Runway", b =>
                {
                    ...
                    b.Property<int>("LenghtFt")
                        .HasColumnType("int");

                    b.Property<string>("Name")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("RunwayHeading1Id")
                        .HasColumnType("int");

                    b.Property<int?>("RunwayHeading2Id")
                        .HasColumnType("int");

                    b.Property<int>("RunwaySurface")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RunwayHeading1Id");

                    b.HasIndex("RunwayHeading2Id");
            ...
            modelBuilder.Entity("BonusPointManager.Models.Flights.RunwaySurface", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BonusPointManager.Models.Flights.Runway", b =>
                {
                    ...
                    b.HasOne("BonusPointManager.Models.Flights.RunwayHeading", "RunwayHeading1")
                        .WithMany()
                        .HasForeignKey("RunwayHeading1Id");

                    b.HasOne("BonusPointManager.Models.Flights.RunwayHeading", "RunwayHeading2")
                        .WithMany()
                        .HasForeignKey("RunwayHeading2Id");

                    b.Navigation("RunwayHeading1");

                    b.Navigation("RunwayHeading2");
                });
